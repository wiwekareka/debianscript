...
# set repo
wget -O /etc/apt/sources.list "https://debianscript.googlecode.com/svn/sources.list.debian7"
...
# screen  permission
# sed -i '$ i\chmod 777 /var/run/screen' /etc/rc.local
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://debianscript.googlecode.com/svn/1194.conf"
...
wget -O /etc/squid3/squid.conf "https://debianscript.googlecode.com/svn/squid3.conf"
